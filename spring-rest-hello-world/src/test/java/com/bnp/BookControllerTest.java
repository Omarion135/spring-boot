...
public class BookControllerTest {
    ...
    public void save_book_OK() throws Exception {
        ...
        Book newBook = new Book(1L, "Spring Boot Guide", "bnp", new BigDecimal("2.99"));
        ...
        mockMvc.perform(post("/books")
                ...
                .andExpect(jsonPath("$.author", is("bnp")))
    ...
    public void update_book_OK() throws Exception {
        ...
        Book updateBook = new Book(1L, "ABC", "bnp", new BigDecimal("19.99"));
